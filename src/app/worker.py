...
class Worker(QtCore.QObject):
    ...
    def setValue(self, file_address, sheet_name, addr_column, distance_column, option, start_row, end_row):
    ...
    def start_work(self):
        ...
        self.fetcher.setValue(config_list, self.file_address, self.sheet_name, self.addr_column, self.distance_column, self.option, self.start_row, self.end_row)
        print('pass')
        self.fetcher.fetch()
